...
const EditQuestionModal = ({ question, onUpdateQuestion, onClose }) => {
  ...
  return (
    <div className="container technology-block">
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Edit Question</h5>
            <button type="btn btn-primary center-button grow-on-hover" className="close" onClick={onClose}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={editedQuestion.correct_answer_index}
                  onChange={handleChange}
                  className="form-control"
                  required
                />
